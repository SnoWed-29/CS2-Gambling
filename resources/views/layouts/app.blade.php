    ...
    <body>
        <nav class="bg-[#F5F7F8] p-2 border-b-2 border-[#F4CE14]">
            <div class="flex container w-9/12 mx-auto justify-around">
                ...
                <a href="" class="text-[#45474B] p-4 mx-1 text-xl font-semibold hover:border-b-2 hover:border-[#F4CE14]">Cases</a>
                <a href="" class="text-[#45474B] p-4 mx-1 text-xl font-semibold hover:border-b-2 hover:border-[#F4CE14]">Create Case</a>
